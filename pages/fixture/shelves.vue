			...
			<view class="box">
				<up-form labelPosition="left" :model="formData" ref="formRef" labelWidth="70">
					<up-form-item label="储位" prop="location">
						<up-input placeholder="储位" @focus="focus" :focus="locatFocus"  v-model="formData.location" clearable @confirm="submitQRCode">
							<template #suffix>
					...
					<up-form-item label="治具编码" prop="compid">
						<up-input placeholder="治具编码" @focus="focus" :focus="barCodeFocus" v-model="formData.compid" @confirm="submitShelves">
							<template #suffix>
